...
public class HystrixGatewayFilterFactory extends AbstractGatewayFilterFactory<HystrixGatewayFilterFactory.Config>{
    ...
    public GatewayFilter apply(Config config){
        ...
        return new GatewayFilter(){
            ...
            public String toString(){
                return filterToStringCreator(HystrixGatewayFilterFactory.this).append("name", config.getName()).append("fallback", config.fallbackUri)
                                .toString();
            }
        };
    }
    ...
    private class RouteHystrixCommand extends HystrixObservableCommand<Void>{
        ...
        protected Observable<Void> resumeWithFallback(){
            ...
            URI requestUrl = UriComponentsBuilder.fromUri(uri).host(null).port(null).uri(this.fallbackUri).scheme(null).build(encoded).toUri();
        ...
        private void addExceptionDetails(){
            ...
            ofNullable(executionException).ifPresent(exception -> exchange.getAttributes().put(HYSTRIX_EXECUTION_EXCEPTION_ATTR, exception));
        }
